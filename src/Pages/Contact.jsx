...
function Contact() {
  return (
    ...
    //   <div className="flex flex-col items-start justify-center mt-20 px-96">
    //     <h1 className="text-2xl text-blue-700 font-bold">{contact.title}</h1>
    //     <p className="mt-8 text-2xl text-gray-700 font-medium">
    //       {contact.description}
    //     </p>
    //     <ul className="flex flex-row mt-8 w-full text-4xl ">
    //       <li className="mr-4 w-16 h-16 hover:text-green-800 transition duration-300 ease-in-out cursor-pointer text-gray-900">
    ...
    //       <li className="mr-4 w-16 h-16 hover:text-green-800 transition duration-300 ease-in-out cursor-pointer text-blue-700">
    //         <span className="flex items-center justify-center h-full w-full rounded-full bg-white shadow-lg shadow-cyan-500/50 transform transition-transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50">
    ...
    //         </span>
    //       </li>
    //       <li className="mr-4 w-16 h-16 hover:text-green-800 transition duration-300 ease-in-out cursor-pointer text-red-700">
    //         <span className="flex items-center justify-center h-full w-full rounded-full bg-white shadow-lg shadow-cyan-500/50 transform transition-transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50">
    ...
    //       <ul className="flex flex-row mt-10 w-32 text-3xl ">
    //         <li className="mr-4 w-16 h-16 hover:text-green-800 transition duration-300 ease-in-out cursor-pointer text-gray-900">
    //           <span className="flex items-center justify-center h-full w-full rounded-full bg-white shadow-lg shadow-cyan-500/50 transform transition-transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50">
    //             <a href={socialLinks.GitHub} target="blank">
    ...
    //         <h1 className="text-base text-blue-700 font-bold">Location</h1>
    //         <p className="text-sm text-gray-700 font-medium">Warsaw, Poland</p>
    //       </div>
    //     </div>
    //   </div>
    // </div>
