...
function Home() {
  ...
  return (
    // <div className="h-[calc(100dvh-60px)] mt-[60px] bg-[#f7f7f7]">
    //   <Decoration />
    //   <div className="h-full flex flex-row items-center justify-between px-48 z-10 relative">
    //     <div className="mr-10">
    //       <div>
    ...
    //         </p>
    //       </div>
    //       <ul className="flex flex-row mt-10 text-4xl text-gray-900 ">
    //         <li className="mr-4 hover:text-red-700 transition duration-300 ease-in-out cursor-pointer">
    //           <a href={socialLinks.GitHub}>
    //             <FontAwesomeIcon icon={faSquareGithub} />
    //           </a>
    //         </li>
    //         <li className="mr-2 hover:text-red-700 transition duration-300 ease-in-out cursor-pointer">
    ...
    //       </ul>
    //     </div>
    //     <div className="flex flex-row items-center justify-start rounded-full p-1 border-[2px] border-gray-400">
    //       <img
